...
<body>
	...
	<section id="container">
		...
		<?php 
			...
			$query = mysqli_query($conection,"SELECT u.idusuario, u.nombre, u.numero, u.usuario, u.center, u.encargado, r.rol FROM usuario u INNER JOIN rol r ON u.rol = r.idrol 
															WHERE 
															( u.idusuario LIKE '%$busqueda%' OR 
															u.nombre LIKE '%$busqueda%' OR 
															u.numero LIKE '%$busqueda%' OR 
															u.usuario LIKE '%$busqueda%' OR
															u.center LIKE '%$busqueda%' OR
															u.encargado  LIKE '%$busqueda%'OR 
															r.rol    LIKE  '%$busqueda%') 
															AND
